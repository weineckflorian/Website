        ...
        <div className="mt-10 flex flex-col gap-3">
          {items.map((item, i) => (
            <details
              ...
              name="faq"
              open={i === 0}
              className="faq-details group overflow-hidden rounded-xl border border-slate-200 bg-slate-50/50 shadow-sm transition-colors open:border-orange-200/80 open:bg-white hover:border-orange-200/60"
            >
              ...
              <div className="border-t border-slate-200 bg-white px-4 py-4 text-slate-600 sm:px-5">
                {item.a}
              </div>
            </details>
          ))}
